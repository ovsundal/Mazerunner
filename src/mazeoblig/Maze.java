...
public class Maze extends Applet {
	...
	private InfoToServerInterface remoteInfoObject;
	private InfoToServer sendInfo;
	...
	public void init() {
		...
		try {
			...
			remoteInfoObject = (InfoToServerInterface) r.lookup(RMIServer.InfoToServerName);
...
// kommentarer. L�sningen er implementert med backtracking-algoritme
			...
			for (int i = 0; i < pos.length; i++) {
				...
				remoteInfoObject.sendPosition(pos[i]);
			}
...
/**/			
	...
	//Get parameter remoteInfoObject
